                              ...
                              <div id="blogslider" class="carousel slide" data-ride="carousel">
                                 <div class="carousel-inner">
                                    ...
                                    <div class="carousel-item">
                                       <img src="assets/image/standard_post_img05.jpg" alt="">
                                       <!--carousel-item-->
                                    </div>
                                    <div class="carousel-item">
                     ...
                     <div class="col-xl-3 col-lg-6">
                        <div class="float-left w-100 post-item border mb-4">
                           <div class="post-item-wrap position-relative">
                              <div class="post-image">
                                 <a href="#">
                                 <img alt="" src="assets/image/standard_post_img02.jpg"> </a> <span class="post-meta-category">
                                 <a href="#">Science</a>
                                 </span>
                                 <!--post-image-->
                              </div>
                     ...
                     <div class="col-xl-3 col-lg-6">
                        <div class="float-left w-100 post-item border mb-4">
                           <div class="post-item-wrap position-relative">
                              <div class="post-image">
                                 <a href="#">
                                 <img alt="" src="assets/image/standard_post_img05.jpg">
                                 </a>
                                 <span class="post-meta-category">
                                 <a href="#">Lifestyle</a>
                                 </span>
