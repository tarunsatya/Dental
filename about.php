            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 d-md-flex align-items-md-end">
                    <div class="quality-system-right-con position-relative text-center overlay-img">
                        ...
                        <figure class="mb-0">
                            <img src="assets/image/professional-doctor-img.png" alt="professional-doctor-img"
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 d-md-flex align-items-md-end order-xl-0 order-lg-0 order-md-0 order-2">
                    <div class="form-left-con core-vaule-left-con position-relative text-center">
                        ...
                        <figure class="mb-0">
                            <img src="assets/image/core-value-left-img.png" alt="form-left-img"
                        ...
                        <div class="core-vaule-box-con">
                            <div class="core-vaule-box-item position-relative">
                                ...
                                <div class="core-vaule-box-title">
                                    ...
                                    <span class="d-block">A physician, medical practitioner, medical doctor, or simply
                                        doctor, is a health professional who practices medicine.</span>
                                </div>
                            </div>
                            <div class="core-vaule-box-item position-relative">
                                <figure class="mb-0">
                                ...
                                <div class="core-vaule-box-title">
                                    <h5>24/7 Helpdesk</h5>
                                    <span class="d-block"> A comprehensive guide with cost-effective methods and best
                                        practices that can help you provide 24/7 support in no time.</span>
                                </div>
                            </div>
                            <div class="core-vaule-box-item position-relative mb-0">
                                ...
                                <div class="core-vaule-box-title">
                                    <h5>Latest Drugs</h5>
                                    <span class="d-block">Analgesics. Non-narcotic analgesics are the most commonly used
                                        drugs for relief of toothache or pain following dental treatment as well as
                                        fever.</span>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-6 order-xl-0 order-lg-0 order-2">
                    <div class="form-left-con position-relative text-center">
                        ...
                        <figure class="mb-0">
                            <img src="assets/image/form-left-img.png" alt="form-left-img"
                                class="mb-0 img-fluid human-img">
                        </figure>
                        <figure class="mb-0 right-curve-img wow slideInRight">
                            <img src="assets/image/small-right-curve-img.png" alt="" class="img-fluid">
