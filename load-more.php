                  ...
                  <div class="w-100 float-left generic-banner-con text-xl-left text-lg-left text-center">
                     <div class="container">
                        <div class="generic-banner-content text-white text-center">
                           <h1>Blog - Load More</h1>
                           <p class="text-white mb-0">FAQ About Dental Health  What type of toothbrush and toothpaste should I use Do I really need to floss Does a rinse or mouthwash help.</p>
                        </div>
                     </div>
                  </div>
               </section>
               ...
               <div id="blog" class="three-column col-xl-12">
                  <div class="row">
                     ...
                     <div class="col-xl-4 col-lg-4">
                        <div class="float-left w-100 post-item border mb-4">
                           <div class="post-item-wrap position-relative">
                              <div class="post-image">
                                 <a href="#">
                                 <img alt="" src="assets/image/standard_post_img03.jpg"> </a> <span class="post-meta-category">
                                 <a href="#">Science</a>
                                 </span>
                                 <!--post-image-->
                              </div>
                     ...
                     <div class="load-more d-inline-block m-auto align-top">
                        <a class="d-block" href="#">Load More</a>
                     </div>
                  </div>
                  <!--blog-->
               </div>
